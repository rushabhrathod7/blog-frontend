...
const CommentCard = ({ index, leftVal, commentData }) => {
  let {
    commented_by: {
      personal_info: {
        profile_img,
        fullname,
        username: commmented_by_username,
      },
    },
    commentedAt,
    comment,
  ...
  const loadReplies = ({ skip = 0, currentIndex = index }) => {
    if (commentsArr[currentIndex].children.length) {
      ...
      axios
        .post(import.meta.env.VITE_SERVER_DOMAIN + "/api/blogs/get-replies", {
  ...
  const deleteComment = (e) => {
    ...
    axios
      .post(
        import.meta.env.VITE_SERVER_DOMAIN + "/api/blogs/delete-comment",
        { _id },
        {
          headers: {
      ...
      <div className="my-5 p-6 rounded-md border border-grey">
        <div className="flex gap-3 items-center mb-8">
          ...
          <p className="line-clamp-1">
            {fullname} @{commmented_by_username}
          </p>
        ...
        <div className="font-gelasio items-center mt-5">
          ...
          {username == commmented_by_username || username == blog_author ? (
            <button
